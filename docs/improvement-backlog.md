...
최종 업데이트: 2026-03-26
현재 점수 추정: Designer 80 / UX 87 / Dev 89 / Marketing 81 / Business 78 (평균 83.0)
...
- [x] 투표 Optimistic UI (대시보드 퀵투표 + 경기 상세 — 즉시 반응, 실패 롤백)
- [ ] 실제 사용자 후기로 소셜프루프 교체 (실명 + 팀명) **[수동+개발]**
- [ ] 회비 미납 알림 (납부현황 탭에서 "미납자 알림 보내기" 버튼 + 크론 자동 발송)
- [x] 회비 첫 사용 온보딩 가이드 (설정 없을 때 3단계 카드, localStorage 닫기 기억)
