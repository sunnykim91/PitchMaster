...
최종 업데이트: 2026-03-27
현재 점수 추정: Designer 82 / UX 88 / Dev 91 / Marketing 81 / Business 78 (평균 84.0)
...
- [ ] 랜딩 페이지 실제 스크린샷 활용 **[수동+개발]**

## 미완료 — MEDIUM (팀 50개 이상 시)

### 기능
- [ ] PK/FK 골 기록 기능 (골 유형 분류)
...
- [ ] 회비 미납 크론 자동 발송 (매월 기준일 후 X일)

### 마케팅/SEO
- [ ] 온보딩 프로그레스 바 추가 (1단계/3단계)
- [ ] guide.html → Next.js 라우트 마이그레이션
- [ ] FAQPage, HowTo 구조화 데이터 추가
- [ ] GA4 커스텀 이벤트 (데모 전환율, 가입 퍼널)

### 풋살 특화
- [ ] 풋살 포지션 UI 활용 (현재 정의만 있고 UI 미사용)
