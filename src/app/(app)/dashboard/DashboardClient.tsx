                  ...
                  <CardContent className="p-4">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      <div className="flex items-center gap-3">
                        <p className="text-xs text-muted-foreground whitespace-nowrap">{formatDateKo(recentResult.date)}</p>
                        {(() => {
                          ...
                          const scoreColor = parts && parts.length === 2
                            ...
                            : "text-primary";
                          return <span className={cn("text-xl font-bold font-[family-name:var(--font-display)]", scoreColor)}>{recentResult.score}</span>;
                        })()}
