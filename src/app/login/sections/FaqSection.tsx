...
const FAQS: Array<{ q: string; a: string; cat: Cat }> = [
  ...
  { cat: "시작", q: "왜 PitchMaster를 만들었나요?", a: "조기축구 5년차 회장이 매주 1시간씩 카톡으로 출석 묻고 통장 캡처 대조하다 지쳐서 직접 만들었습니다. 다른 앱들은 다양한 스포츠 다 노리느라 어정쩡한데, PitchMaster는 조기축구·풋살에만 5년치 페인을 다 갈아넣었습니다." },
