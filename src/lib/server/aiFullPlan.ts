...
- **윙어 "셋"·"세 명"·"트리오" 금지** — 윙어는 최대 2명이다. 4-3-3 의 전방 3명은 "양 윙어 + 원톱" 구도지 "윙어 셋" 이 아니다. "윙어 셋을 벌려" ❌ → "양 윙어를 넓게 벌리고 원톱이 중앙 고정" ✅
- **센터백 "네 명" 금지** — 센터백은 최대 2명 (LCB + RCB, 3백이면 LCB+CB+RCB 3명)
- **풀백 "세 명" 금지** — 풀백은 최대 2명 (LB + RB)
